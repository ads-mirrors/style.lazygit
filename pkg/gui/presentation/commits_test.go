...
func TestGetCommitListDisplayStrings(t *testing.T) {
	...
	scenarios := []struct {
		...
		},
		{
			...
			commits: []*models.Commit{
				{Name: "commit1", Hash: pool("hash1"), Parents: []*string{pool("hash2"), pool("hash3")}},
				{Name: "commit2", Hash: pool("hash2"), Parents: []*string{pool("hash3")}},
				{Name: "commit3", Hash: pool("hash3"), Parents: []*string{pool("hash4")}},
				{Name: "commit4", Hash: pool("hash4"), Parents: []*string{pool("hash5")}},
				{Name: "commit5", Hash: pool("hash5"), Parents: []*string{pool("hash7")}},
			},
			startIdx:                  0,
			endIdx:                    5,
			showGraph:                 true,
		...
		},
		{
			...
			commits: []*models.Commit{
				{Name: "commit1", Hash: pool("hash1"), Parents: []*string{pool("hash2"), pool("hash3")}, Action: todo.Pick},
				{Name: "commit2", Hash: pool("hash2"), Parents: []*string{pool("hash3")}, Action: todo.Pick},
				{Name: "commit3", Hash: pool("hash3"), Parents: []*string{pool("hash4")}},
				{Name: "commit4", Hash: pool("hash4"), Parents: []*string{pool("hash5")}},
				{Name: "commit5", Hash: pool("hash5"), Parents: []*string{pool("hash7")}},
			},
		...
		},
		{
			...
			commits: []*models.Commit{
				{Name: "commit1", Hash: pool("hash1"), Parents: []*string{pool("hash2"), pool("hash3")}, Action: todo.Pick},
				{Name: "commit2", Hash: pool("hash2"), Parents: []*string{pool("hash3")}, Action: todo.Pick},
				{Name: "commit3", Hash: pool("hash3"), Parents: []*string{pool("hash4")}, Action: todo.Pick},
				{Name: "commit4", Hash: pool("hash4"), Parents: []*string{pool("hash5")}, Action: todo.Pick},
				{Name: "commit5", Hash: pool("hash5"), Parents: []*string{pool("hash7")}},
			},
			startIdx:                  0,
			endIdx:                    2,
		...
		},
		{
			...
			commits: []*models.Commit{
				{Name: "commit1", Hash: pool("hash1r"), Parents: []*string{pool("hash2r")}, Divergence: models.DivergenceRight},
				{Name: "commit2", Hash: pool("hash2r"), Parents: []*string{pool("hash3r"), pool("hash5r")}, Divergence: models.DivergenceRight},
				{Name: "commit3", Hash: pool("hash3r"), Parents: []*string{pool("hash4r")}, Divergence: models.DivergenceRight},
				{Name: "commit1", Hash: pool("hash1l"), Parents: []*string{pool("hash2l")}, Divergence: models.DivergenceLeft},
				{Name: "commit2", Hash: pool("hash2l"), Parents: []*string{pool("hash3l"), pool("hash4l")}, Divergence: models.DivergenceLeft},
				{Name: "commit3", Hash: pool("hash3l"), Parents: []*string{pool("hash4l")}, Divergence: models.DivergenceLeft},
				{Name: "commit4", Hash: pool("hash4l"), Parents: []*string{pool("hash5l")}, Divergence: models.DivergenceLeft},
				{Name: "commit5", Hash: pool("hash5l"), Parents: []*string{pool("hash6l")}, Divergence: models.DivergenceLeft},
			},
			startIdx:                  0,
			endIdx:                    8,
			showGraph:                 true,
